...
elseif ($_REQUEST['act'] == 'add' || $_REQUEST['act'] == 'edit' || $_REQUEST['act'] == 'copy')
{
    ...
    else
    {
        ...
        // }
            $goods['promote_end_date'] = local_date('Y-m-d', $goods['promote_end_date']+60*60*24);

           // local_date('Y-m-d', gmstr2tome('+1 month')),
...
elseif ($_REQUEST['act'] == 'insert' || $_REQUEST['act'] == 'update')
{
    ...
    $supply_price = !empty($_POST['supply_price']) ? $_POST['supply_price'] : 0;
   ...
   // $promote_end_date = ($is_promote && !empty($_POST['promote_end_date'])) ? local_strtotime($_POST['promote_end_date']) : 0;
    $promote_end_date = !empty($_POST['promote_end_date2']) ? local_strtotime($_POST['promote_end_date2']) : 0;
     $brand_discount = !empty($_POST['brand_discount']) ? $_POST['brand_discount'] : 0;
     $brand_discount_end_date = !empty($_POST['brand_discount_end_date']) ? $_POST['brand_discount_end_date'] : 0;
    ...
    if ($is_insert)
    {
        if ($code == '')
        {
            $sql = "INSERT INTO " . $ecs->table('goods') . " (goods_name,korea_name, goods_name_style, goods_sn, " .
            "cat_id, brand_id, shop_price, supply_price,market_price, virtual_sales, is_promote, promote_price, " .
                    "promote_start_date, promote_end_date,brand_discount,brand_discount_end_date, goods_img, goods_thumb, original_img, keywords, goods_brief, " .
                ...
                "VALUES ('$_POST[goods_name]','$_POST[korea_name]', '$goods_name_style', '$goods_sn', '$catgory_id', " .
                "'$brand_id', '$shop_price','$supply_price', '$market_price', '$virtual_sales', '$is_promote','$promote_price', ".
                    "'$promote_start_date', '$promote_end_date','$brand_discount','$brand_discount_end_date', '$goods_img', '$goods_thumb', '$original_img', ".
    ...
    else
    {
        ...
        $sql = "UPDATE " . $ecs->table('goods') . " SET " .
                ...
                "brand_discount_end_date = '$brand_discount_end_date', ";
