...
$modules['02_cat_and_goods']['goodsbag'] = 'goods_bag_add.php?act=list';
/*
...
$modules['04_order']['01_order_list']               = 'order.php?act=list2';
...
$modules['04_order']['11_delivery_email']           = 'order.php?act=delivery_email';
