...
<div class="list-div" style="border: 1px solid #CC0000">
  <table cellspacing='1' cellpadding='3'>
    ...
    <?php $_from = $this->_var['admin_msg']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'msg_0_53505400_1541053783');if (count($_from)):
    foreach ($_from AS $this->_var['msg_0_53505400_1541053783']):
?>
      <tr align="center">
        <td align="left"><a href="message.php?act=view&id=<?php echo $this->_var['msg_0_53505400_1541053783']['message_id']; ?>"><?php echo sub_str($this->_var['msg_0_53505400_1541053783']['title'],60); ?></a></td>
        <td><?php echo $this->_var['msg_0_53505400_1541053783']['user_name']; ?></td>
        <td><?php echo $this->_var['msg_0_53505400_1541053783']['send_date']; ?></td>
      </tr>
    <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
  </table>
  </div>
