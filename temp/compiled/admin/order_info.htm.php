...
<table width="100%" cellpadding="3" cellspacing="1">
  <tr>
    <td colspan="4">
      <div align="center">
        ...
        <input type="button" onclick="window.open('order.php?act=info&order_id=<?php echo $this->_var['order']['order_id']; ?>&print=1')" class="button" value="<?php echo $this->_var['lang']['print_order']; ?>"  <?php if ($this->_var['node_info']): ?>disabled<?php endif; ?>/>
    </div></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td width="34%">
      ...
      <?php if ($this->_var['order']['ishongkong']): ?>
        <span style='color:red'>hongkong</span>
      <?php endif; ?>
      <?php if ($this->_var['order']['extension_code'] == "group_buy"): ?><a href="group_buy.php?act=edit&id=<?php echo $this->_var['order']['extension_id']; ?>"><?php echo $this->_var['lang']['group_buy']; ?></a><?php elseif ($this->_var['order']['extension_code'] == "exchange_goods"): ?><a href="exchange_goods.php?act=edit&id=<?php echo $this->_var['order']['extension_id']; ?>"><?php echo $this->_var['lang']['exchange_goods']; ?></a><?php endif; ?></td>
  ...
  <tr>
    ...
    <td><?php echo empty($this->_var['order']['user_name']) ? $this->_var['lang']['anonymous'] : $this->_var['order']['user_name']; ?> <?php if ($this->_var['order']['user_id'] > 0): ?>[ <a href="" onclick="staticbar();return false;"><?php echo $this->_var['lang']['display_buyer']; ?></a> ] <?php if (! $this->_var['node_info']): ?>[ <a href="user_msg.php?act=add&order_id=<?php echo $this->_var['order']['order_id']; ?>&user_id=<?php echo $this->_var['order']['user_id']; ?>" ><?php echo $this->_var['lang']['send_message']; ?></a> ]<?php endif; ?><?php endif; ?></td>
  ...
  <tr>
    ...
    <td><?php if ($this->_var['order']['pay_id'] > 0): ?><?php echo $this->_var['order']['pay_name']; ?><?php else: ?><?php echo $this->_var['lang']['require_field']; ?><?php endif; ?><?php if (! $this->_var['node_info']): ?><a href="order.php?act=edit&order_id=<?php echo $this->_var['order']['order_id']; ?>&step=payment" class="special"><?php echo $this->_var['lang']['edit']; ?></a><?php endif; ?>
    (<?php echo $this->_var['lang']['action_note']; ?>: <?php if ($this->_var['node_info']): ?><?php if ($this->_var['order']['pay_note']): ?><?php echo $this->_var['order']['pay_note']; ?><?php else: ?>N/A<?php endif; ?><?php else: ?><span onclick="listTable.edit(this, 'edit_pay_note', <?php echo $this->_var['order']['order_id']; ?>)"><?php if ($this->_var['order']['pay_note']): ?><?php echo $this->_var['order']['pay_note']; ?><?php else: ?>N/A<?php endif; ?></span><?php endif; ?>)</td>
  ...
  <tr>
    ...
    <td><?php if ($this->_var['exist_real_goods']): ?><?php if ($this->_var['order']['shipping_id'] > 0): ?><?php echo $this->_var['order']['shipping_name']; ?><?php else: ?><?php echo $this->_var['lang']['require_field']; ?><?php endif; ?><?php if (! $this->_var['node_info']): ?><a href="order.php?act=edit&order_id=<?php echo $this->_var['order']['order_id']; ?>&step=shipping" class="special"><?php echo $this->_var['lang']['edit']; ?></a>&nbsp;&nbsp;<input type="button" onclick="window.open('order.php?act=info&order_id=<?php echo $this->_var['order']['order_id']; ?>&shipping_print=1')" class="button" value="<?php echo $this->_var['lang']['print_shipping']; ?>"> <?php endif; ?><?php if ($this->_var['order']['insure_fee'] > 0): ?>（<?php echo $this->_var['lang']['label_insure_fee']; ?><?php echo $this->_var['order']['formated_insure_fee']; ?>）<?php endif; ?><?php endif; ?></td>
  ...
  <tr>
    ...
    <td><?php if ($this->_var['order']['shipping_id'] > 0 && $this->_var['order']['shipping_status'] > 0): ?><span><?php if ($this->_var['order']['invoice_no']): ?><?php echo $this->_var['order']['invoice_no']; ?><?php else: ?>N/A<?php endif; ?></span><?php if (! $this->_var['node_info']): ?><a href="order.php?act=edit&order_id=<?php echo $this->_var['order']['order_id']; ?>&step=shipping" class="special"><?php echo $this->_var['lang']['edit']; ?></a><?php endif; ?><?php endif; ?></td>
    <td><div align="right"><strong><?php echo $this->_var['lang']['from_order']; ?></strong></div></td>
    <td><?php echo $this->_var['order']['referer']; ?></td>
  </tr>
  <tr>
    <th colspan="4"><?php echo $this->_var['lang']['other_info']; ?><?php if (! $this->_var['node_info']): ?><a href="order.php?act=edit&order_id=<?php echo $this->_var['order']['order_id']; ?>&step=other" class="special"><?php echo $this->_var['lang']['edit']; ?></a><?php endif; ?></th>
    </tr>
  <tr>
  ...
  <tr>
    <th colspan="4"><?php echo $this->_var['lang']['consignee_info']; ?><?php if (! $this->_var['node_info']): ?><a href="order.php?act=edit&order_id=<?php echo $this->_var['order']['order_id']; ?>&step=consignee" class="special"><?php echo $this->_var['lang']['edit']; ?></a><?php endif; ?></th>
    </tr>
  <tr>
...
<table width="100%" cellpadding="3" cellspacing="1">
  <tr>
    <th colspan="10" scope="col"><?php echo $this->_var['lang']['goods_info']; ?><?php if (! $this->_var['node_info']): ?><a href="order.php?act=edit&order_id=<?php echo $this->_var['order']['order_id']; ?>&step=goods" class="special"><?php echo $this->_var['lang']['edit']; ?></a><?php endif; ?></th>
    </tr>
  <tr>
    ...
    <td scope="col"><div align="center"><strong>发货状态</strong></div></td>
...
?>
  <tr>
    <td><img src="/<?php echo $this->_var['goods']['goods_img']; ?>" width=80 />
    <br />
      <?php echo $this->_var['order']['order_sn']; ?>
...
<table width="100%" cellpadding="3" cellspacing="1">
  <tr>
    <th><?php echo $this->_var['lang']['fee_info']; ?><?php if (! $this->_var['node_info']): ?><a href="order.php?act=edit&order_id=<?php echo $this->_var['order']['order_id']; ?>&step=money" class="special"><?php echo $this->_var['lang']['edit']; ?></a><?php endif; ?></th>
  </tr>
  <tr>
...
- <?php echo $this->_var['lang']['label_discount']; ?><strong><?php echo $this->_var['order']['formated_discount']; ?></strong> - <?php echo $this->_var['lang']['label_goods_discount_fee']; ?><strong><?php echo $this->_var['order']['formated_goods_discount_fee']; ?></strong>     + <?php echo $this->_var['lang']['label_tax']; ?><strong><?php echo $this->_var['order']['formated_tax']; ?></strong>
  ...
  <tr>
    <td><div align="right"> = <?php if ($this->_var['order']['order_amount'] >= 0): ?><?php echo $this->_var['lang']['label_money_dues']; ?><strong><?php echo $this->_var['order']['formated_order_amount']; ?></strong>
     ...
     <?php if (! $this->_var['node_info']): ?> <input name="refund" type="button" value="<?php echo $this->_var['lang']['refund']; ?>" onclick="location.href='order.php?act=process&func=load_refund&anonymous=<?php if ($this->_var['order']['user_id'] <= 0): ?>1<?php else: ?>0<?php endif; ?>&order_id=<?php echo $this->_var['order']['order_id']; ?>&refund_amount=<?php echo $this->_var['order']['money_refund']; ?>'" /><?php endif; ?>
...
<table cellpadding="3" cellspacing="1">
  ...
  <td colspan="5"><textarea name="action_note" cols="80" rows="3" <?php if ($this->_var['node_info']): ?>disabled<?php endif; ?> ></textarea></td>
    </tr>
  <tr>
    ...
    <td colspan="5"><?php if ($this->_var['operable_list']['confirm']): ?>
      <input name="confirm" type="submit" value="<?php echo $this->_var['lang']['op_confirm']; ?>" class="button" <?php if ($this->_var['node_info']): ?>disabled<?php endif; ?> />
        <?php endif; ?> <?php if ($this->_var['operable_list']['pay']): ?>
        <input name="pay" type="submit" value="<?php echo $this->_var['lang']['op_pay']; ?>" class="button" <?php if ($this->_var['node_info']): ?>disabled<?php endif; ?> />
        <?php endif; ?> <?php if ($this->_var['operable_list']['unpay']): ?>
        <input name="unpay" type="submit" class="button" value="<?php echo $this->_var['lang']['op_unpay']; ?>" <?php if ($this->_var['node_info']): ?>disabled<?php endif; ?> />
        <?php endif; ?> <?php if ($this->_var['operable_list']['prepare']): ?>
        <input name="prepare" type="submit" value="<?php echo $this->_var['lang']['op_prepare']; ?>" class="button" <?php if ($this->_var['node_info']): ?>disabled<?php endif; ?> />
        <?php endif; ?> <?php if ($this->_var['operable_list']['split']): ?>
        <input name="ship" type="submit" value="<?php echo $this->_var['lang']['op_split']; ?>" class="button" <?php if ($this->_var['node_info']): ?>disabled<?php endif; ?> />
        <?php endif; ?> <?php if ($this->_var['operable_list']['unship']): ?>
        <input name="unship" type="submit" value="<?php echo $this->_var['lang']['op_unship']; ?>" class="button" <?php if ($this->_var['node_info']): ?>disabled<?php endif; ?> />
        <?php endif; ?> <?php if ($this->_var['operable_list']['receive']): ?>
        <input name="receive" type="submit" value="<?php echo $this->_var['lang']['op_receive']; ?>" class="button" <?php if ($this->_var['node_info']): ?>disabled<?php endif; ?> />
        <?php endif; ?> <?php if ($this->_var['operable_list']['cancel']): ?>
        <input name="cancel" type="submit" value="<?php echo $this->_var['lang']['op_cancel']; ?>" class="button" <?php if ($this->_var['node_info']): ?>disabled<?php endif; ?> />
        <?php endif; ?> <?php if ($this->_var['operable_list']['invalid']): ?>
        <input name="invalid" type="submit" value="<?php echo $this->_var['lang']['op_invalid']; ?>" class="button" <?php if ($this->_var['node_info']): ?>disabled<?php endif; ?> />
        <?php endif; ?> <?php if ($this->_var['operable_list']['return']): ?>
        <input name="return" type="submit" value="<?php echo $this->_var['lang']['op_return']; ?>" class="button" <?php if ($this->_var['node_info']): ?>disabled<?php endif; ?> />
        <?php endif; ?> <?php if ($this->_var['operable_list']['to_delivery']): ?>
        <input name="to_delivery" type="submit" value="<?php echo $this->_var['lang']['op_to_delivery']; ?>" class="button" <?php if ($this->_var['node_info']): ?>disabled<?php endif; ?>/>
        <input name="order_sn" type="hidden" value="<?php echo $this->_var['order']['order_sn']; ?>" />
        <?php endif; ?> <input name="after_service" type="submit" value="<?php echo $this->_var['lang']['op_after_service']; ?>" class="button" <?php if ($this->_var['node_info']): ?>disabled<?php endif; ?> /><?php if ($this->_var['operable_list']['remove']): ?>
        <input name="remove" type="submit" value="<?php echo $this->_var['lang']['remove']; ?>" class="button" onClick="return window.confirm('<?php echo $this->_var['lang']['js_languages']['remove_confirm']; ?>');" <?php if ($this->_var['node_info']): ?>disabled<?php endif; ?>/>
        <?php endif; ?>
        ...
        <input name="assign" type="submit" value="<?php echo $this->_var['lang']['op_assign']; ?>" class="button" onclick="return assignTo(document.forms['theForm'].elements['agency_id'].value)" <?php if ($this->_var['node_info']): ?>disabled<?php endif; ?> />
