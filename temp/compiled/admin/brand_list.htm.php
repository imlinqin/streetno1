...
?>
    <tr>
      ...
      <td><a target="_bank" href="./orderpaizi.php?act=delivery_email&brand=<?php echo $this->_var['brand']['brand_name']; ?>&password=<?php echo $this->_var['brand']['password_paizi']; ?>">
         http://streetno1.com/admin/orderpaizi.php?act=delivery_email&brand=<?php echo $this->_var['brand']['brand_name']; ?>&password=<?php echo $this->_var['brand']['password_paizi']; ?>
      </a></td>
      <td align="left"><img src="images/<?php if ($this->_var['brand']['huilv']): ?>yes<?php else: ?>no<?php endif; ?>.gif"  /></td>
