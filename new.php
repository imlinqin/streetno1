...
if (empty($_GET['encode']))
{
    ...
    header("Location: new.php?encode=$string\n");
...
else
{
   ...
   // echo b.promote/100;
    ...
    /* 分页 */
    $url_format = "new.php?category=$category&amp;keywords=" . urlencode(stripslashes($_REQUEST['keywords'])) . "&amp;brand=" . $_REQUEST['brand']."&amp;action=".$action."&amp;goods_type=" . $_REQUEST['goods_type'] . "&amp;sc_ds=" . $_REQUEST['sc_ds'];
    if (!empty($intromode))
    {
    ...
    $pager = get_pager('new.php', $pager['search'], $count, $page, $size);
