...
else
{
    ...
    if (!empty($_REQUEST['keywords']))
    {
        ...
        foreach ($arr AS $key => $val)
        {
            ...
            $keywords  .= "(goods_name LIKE '%$val%' OR b.brand_name LIKE '%$val%' OR goods_sn LIKE '%$val%' OR keywords LIKE '%$val%' $sc_dsad)";
    ...
    /* 查询商品 */
    $sql = "SELECT g.goods_id, g.goods_name, g.market_price, b.brand_name, g.is_new, g.is_best, g.is_hot, g.shop_price AS org_price, ".
